...
urlpatterns = [
    ...
    path("preguntas-frecuentes/", faq_public_view, name="faq_public"),
    path("quejas-propuestas/", complaint_form_view, name="complaint_form"),
    ...
    path("configuracion/ayuda/", help_hub_view, name="help_hub"),
    path("configuracion/ayuda/faq/", faq_owner_view, name="faq_owner"),
    path("configuracion/ayuda/faq/crear/", faq_create_view, name="faq_create"),
    path("configuracion/ayuda/faq/<int:pk>/editar/", faq_update_view, name="faq_update"),
    path("configuracion/ayuda/faq/<int:pk>/eliminar/", faq_delete_view, name="faq_delete"),
    path("configuracion/ayuda/faq/reordenar/", faq_reorder_view, name="faq_reorder"),
    path("configuracion/ayuda/tutoriales/", tutorial_list_view, name="tutorial_list"),
    path("configuracion/ayuda/quejas-propuestas/", complaint_list_view, name="complaint_list"),
    path("configuracion/ayuda/quejas-propuestas/<int:pk>/marcar-leido/", complaint_mark_read_view, name="complaint_mark_read"),
    ...
    path("productos/<int:product_id>/media/reorder/", product_media_reorder_view, name="product_media_reorder"),
    path("productos/<int:product_id>/media/<int:media_id>/eliminar/", product_media_delete_view, name="product_media_delete"),
